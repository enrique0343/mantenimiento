...
router.get('/consumption-report', authenticate, sp.consumptionReport);
...
router.patch('/:id/safety-stock', authenticate, requireRoles('ADMIN', 'MAINTENANCE_CHIEF'), sp.setSafetyStock);
